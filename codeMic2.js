...
let userInput = document.querySelector('.chatbot-input-field');
...
function initVoiceRecognition() {
    ...
    recognition.onstart = function() {
        ...
        console.log('Started listening in language:', getSelectedLanguage());
    };
...
if (languageSelect) {
    languageSelect.addEventListener('change', function() {
        console.log('Language changed to:', getSelectedLanguage());
        // If currently recording, restart with new language
        if (isRecording) {
            stopVoiceRecognition();
            // Small delay to ensure proper stopping before restart
            setTimeout(() => {
                startVoiceRecognition();
            }, 500);
        }
